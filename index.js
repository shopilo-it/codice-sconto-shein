#!/usr/bin/env node
/**
 * Fetch coduri reducere Shein de pe shopilo.it
 * Homepage: https://shopilo.it/magazin/shein.com
 */

const SHOPILO_URL = "https://shopilo.it/magazin/shein.com";
const STORE_NAME  = "Shein";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-shein)" }
  });
