#!/usr/bin/env python3
"""
Fetch coduri de reducere Shein de pe shopilo.it
Sursa: https://shopilo.it/magazin/shein.com
"""
...
SHOPILO_URL = "https://shopilo.it/magazin/shein.com"
STORE_NAME = "Shein"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru Shein de pe shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-shein)"
    }
    try:
