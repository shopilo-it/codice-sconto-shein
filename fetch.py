#!/usr/bin/env python3
"""
Recupero codici sconto Shein da shopilo.it
Sursa: https://shopilo.it/negozi/shein.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/shein.com"
STORE_NAME = "Shein"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Shein da shopilo.it"""
    headers = {
